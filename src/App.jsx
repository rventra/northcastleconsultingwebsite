...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* MASS TORT PAGE - Placeholder for now */}
      {currentPage === 'mass-tort' && (
        <div className="pt-24 min-h-screen">
          <div className="max-w-7xl mx-auto px-6 py-20">
            <h1 className="text-5xl font-bold text-slate-900 mb-6">Mass Tort Services</h1>
            <p className="text-xl text-gray-600">Comprehensive mass tort lifecycle solutions coming soon. Contact us to learn more.</p>
            <div className="mt-8">
              <a 
                href="mailto:contact@northcastleconsulting.com"
                className="inline-block bg-yellow-600 text-slate-900 px-8 py-3 rounded-full font-semibold hover:bg-yellow-500 transition-all"
              >
                Contact Us
              </a>
            </div>
            ...
            <div className="text-center">
              <div className="inline-block bg-blue-50 rounded-2xl p-12 mb-8">
                ...
                <p className="text-xl text-gray-600 mb-8">
                  We're preparing valuable content and insights for you.
                </p>
                <a 
