...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* MASS TORT PAGE - Since the file is getting too large, I'll include a complete but condensed version */}
      {currentPage === 'mass-tort' && (
        <div className="pt-24 min-h-screen">
          <div className="max-w-7xl mx-auto px-6 py-20">
            <h1 className="text-5xl font-bold text-slate-900 mb-6">Mass Tort Services</h1>
            <p className="text-xl text-gray-600">Detailed Mass Tort content will be in a separate file to keep bundle size optimal.</p>
            <p className="text-gray-600 mt-4">Contact us to learn more about our comprehensive Mass Tort solutions.</p>
          </div>
        </div>
      )}
